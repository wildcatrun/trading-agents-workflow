  ...
  properties: {
    action: {
      ...
      enum: [
        ...
        "workflow.next_actions.preview",
        "workflow.next-actions.preview",
        "workflow.v2.readiness.preview",
        "workflow.v2.next_actions.preview",
        "workflow.v2.next-actions.preview",
        "workflow.v2.next_decision.preview",
        ...
        "dispatch.package.callsites",
        "dispatch.package.callsites.preview",
        "dispatch.package.call_sites.preview",
        "dispatch.package.parity",
        "dispatch.package.parity.preview",
        "dispatch.package.schema",
        "dispatch.package.schema.preview",
        "dispatch.package.topology",
        "dispatch.package.topology.preview",
        "dispatch.package",
        "dispatch.package.preview",
        "dispatch.package.create",
        "workflow.dispatch.package.callsites",
        "workflow.dispatch.package.callsites.preview",
        "workflow.dispatch.package.call_sites.preview",
        "workflow.dispatch.package.parity",
        "workflow.dispatch.package.parity.preview",
        "workflow.dispatch.package.schema",
        "workflow.dispatch.package.schema.preview",
        "workflow.dispatch.package.topology",
        "workflow.dispatch.package.topology.preview",
        "workflow.dispatch.topology.preview",
        "workflow.dispatch.package",
        "workflow.dispatch.package.preview",
        "workflow.dispatch.package.create",
        "meeting.dispatch",
        "meeting.ingest",
...
function registerCli(api) {
  api.registerCli(({ program }) => {
    ...
    command.command("runtime-agent")
      ...
      .option("--runtime <runtimeKey>", "Registry runtime key, for example hermers, openclaw, or local_codex")
      .option("--name <displayName>", "Display name")
      .option("--role <role>", "Agent role")
      .option("--execution-adapter <adapter>", "native, acp, api, webhook, queue")
      .option("--im-ingress-owner <owner>", "openclaw_gateway, external_platform, none")
      .option("--im-ingress-adapter <adapter>", "openclaw_native, platform_im, custom")
      .option("--workflow-ingress-adapter <adapter>", "openclaw_native, acp, api, webhook, queue")
      .option("--im-identity <identity>", "IM identity or provider account id")
