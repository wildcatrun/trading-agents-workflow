...
export const WORKFLOW_V2_WORKFLOW_STATES = new Set(["draft", "planned", "active", "waiting_worker", "waiting_review", "waiting_manager", "waiting_group_discussion", "waiting_governance_review", "waiting_protocol_audit", "waiting_cat_brain_check", "waiting_cat_claw_audit", "human_gate_request_due", "waiting_human", "blocked", "completed", "terminated", "cancelled"]);
...
export const WORKFLOW_V2_HUMAN_GATE_PACKAGE_STATUSES = new Set(["draft", "protocol_audited", "cat_claw_audited"]);
