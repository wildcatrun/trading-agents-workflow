...
export const WORKFLOW_V2_WORKFLOW_STATES = new Set(["draft", "planned", "active", "waiting_worker", "waiting_review", "waiting_manager", "waiting_group_discussion", "waiting_cat_brain_check", "waiting_cat_claw_audit", "human_gate_request_due", "waiting_human", "blocked", "completed", "terminated", "cancelled"]);
...
export const WORKFLOW_V2_CAT_BRAIN_AUDIT_DECISIONS = new Set(["approved", "revision_required", "rejected", "needs_human_gate"]);
export const WORKFLOW_V2_CAT_CLAW_AUDIT_DECISIONS = new Set(["protocol_ready", "protocol_revision_required", "rejected"]);
export const WORKFLOW_V2_HUMAN_GATE_PACKAGE_STATUSES = new Set(["draft", "cat_claw_audited"]);
