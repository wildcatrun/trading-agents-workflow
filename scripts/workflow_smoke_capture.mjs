...
const DEFAULT_COMMANDS = [
  ...
  "smoke:v2-external-runner-execute-guard-authorized",
  "smoke:v2-external-runner-execute-guard-missing-binding",
  "smoke:v2-external-runner-execute-guard-invalid-auth",
  "smoke:v2-external-runner-execute-guard-missing-env-gate",
  "smoke:v2-external-runner-execute-guard-missing-core-bindings",
  "smoke:v2-external-runner-execute-guard-mismatched-worker",
  "smoke:v2-external-runner-execute-guard-auth-non-object",
  "smoke:v2-external-runner-execute-guard-missing-auth-json",
