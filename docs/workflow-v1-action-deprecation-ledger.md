...
| `workflow.advance`, `workflow.supervise` | `legacy_active` | v2 validate/review/audit/readiness | P11 audit confirms these are not deletion-ready: migrate next-decision, dispatch/receipt sync, checkpoint, runtime-drain, and Cat Claw closeout behavior into v2/shared readiness before freezing. |
